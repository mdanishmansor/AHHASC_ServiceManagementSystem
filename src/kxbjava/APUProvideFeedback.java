 ...
 * @author User
 */
public class APUProvideFeedback extends javax.swing.JFrame {

    /**
     * Creates new form APUProvideFeedback
     */
    public APUProvideFeedback() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Customer Feedback");

        tblFeedback.setBackground(new java.awt.Color(237, 237, 237));
        tblFeedback.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        tblFeedback.setForeground(new java.awt.Color(37, 42, 52));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(APUProvideFeedback.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new APUProvideFeedback().setVisible(true);
            }
        });
    }
